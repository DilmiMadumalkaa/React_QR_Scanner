...
export default function HomePage() {
  ...
  const handleSearch = () => {
    if (!filters.assetID) {
      setPopup({ show: true, message: "Please enter an Asset ID to search", asset: null, isNew: false });
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden relative text-gray-800">
      ...
      <main className="pt-2 justify-center relative z-10 mx-5">
        ...
        {/* Search & Filters */}
        <div className="w-full max-w-4xl mx-auto mt-8 p-4 bg-gray-100 rounded-lg shadow-sm">
          <h2 className="text-lg font-semibold mb-4">Search / Filter Assets</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            {/* Asset Name Dropdown */}
            <div>
              <label className="block mb-1 text-sm font-medium">Asset Name</label>
              <select
                className="w-full border border-gray-300 rounded px-3 py-2"
            ...
            {/* Asset ID Input */}
            <div>
              <label className="block mb-1 text-sm font-medium">Asset ID</label>
              <input
                type="text"
      ...
      {popup.show && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          {/* Modal content */}
          <div className="relative bg-white rounded-xl shadow-xl p-6 w-96 mx-4 animate-scaleUp">
            <div className="flex flex-col items-center">
              ...
              <div className="flex justify-center gap-4 w-full">
                ...
                >
                  {popup.isNew ? "Add Asset" : "Go to Log Fault"}
                </button>
                <button
